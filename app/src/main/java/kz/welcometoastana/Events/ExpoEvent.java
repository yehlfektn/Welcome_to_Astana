    ...
    public void loadRecyclerView() {
        ...
        if (MainActivity.dateTimeFrom != null) {
            ...
            if (MainActivity.dateTimeTo != null) {
                ...
                Url = "http://89.219.32.107/api/v1/places/events?limit=2000&page=1&category=76" + "&from=" + formatDateTime.format(dateFrom.getTime()) + "&to=" + formatDateTime.format(dateTo.getTime());
            } else {
