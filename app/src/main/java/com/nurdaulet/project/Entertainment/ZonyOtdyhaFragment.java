...
public class ZonyOtdyhaFragment extends Fragment {
    ...
    private static final String Url = "http://welcometoastana.kz/api/v1/places/shopping?limit=20&page=1&category=30";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_zony_otdyha, container, false);


        recyclerView = (RecyclerView) v.findViewById(R.id.recycleZony);
